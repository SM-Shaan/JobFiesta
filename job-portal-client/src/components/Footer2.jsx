    ...
    <div className='footer'>
        ...
        <div className='newsletter'>
            <div className='news-left'>
                <h4 className=' p-2 m-4'>Subscribe</h4>
                <h1 className='p-2 m-4'> Subscribe To Get Latest <br />Update From Us</h1>
                <span className='curve '><img src="./images/curve.png" alt="" /></span>
            </div>
        ...
        <div>
            ...
            <Link to="/" className='float-right m-3 bg-slate-300 p-4'>&#8593;</Link>
        </div>
