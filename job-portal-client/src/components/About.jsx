        ...
        <motion.div
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start gap-10">
                <div
                    ...
                    <Link to="/about" className="bg-blue rounded-full py-2 px-3 text-white font-bold mt-4">About Us</Link>
                </div>
                <div className="w-full lg:w-3/4">
                    <div className="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 items-start md:gap-12 gap-8">
                        <div className="bg-[rgba(255,255,255,0,0.04)] rounded-[35px] h-96 shadow-3xl p-8 items-center flex justify-center items-center hover:-translate-y-4 transition-all duration-300 cursor-pointer">
                            <div>
                                <img src="/images/guide.jpeg" alt="" />
                                <h5 className="text-2xl font-semibold text-primary px-5 text-center mt-5">Career Guidelines</h5>
                            </div>
                        </div>
                        <div className="bg-[rgba(255,255,255,0,0.04)] rounded-[35px] h-96 shadow-3xl p-8 items-center flex justify-center items-center hover:-translate-y-4 transition-all duration-300 cursor-pointer md:mt-16">
                            <div>
